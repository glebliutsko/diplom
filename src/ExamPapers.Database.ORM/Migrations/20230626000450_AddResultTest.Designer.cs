...
namespace ExamPapers.Database.ORM.Migrations
{
    ...
    [Migration("20230626000450_AddResultTest")]
    partial class AddResultTest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExamPapers.Database.ORM.Models.TestingResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("DistributionTestId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ExamPapers.Database.ORM.Models.TestingResult", b =>
                {
                    b.HasOne("ExamPapers.Database.ORM.Models.DistributionTest", "DistributionTest")
                        .WithMany()
                        .HasForeignKey("DistributionTestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DistributionTest");
                });
